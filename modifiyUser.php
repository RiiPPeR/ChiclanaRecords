...
if (!isset($_SESSION['user'])) {
	...
	if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])) {
		if ($_SESSION['user']['rol'] == true || $_SESSION['user']['id'] == $_GET['id']) {
			$id = $_GET['id'];
			$userDAO = new UserDAO();
		...
		<div class="container">
			...
			<div class="card mt-3 col-12">
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" id="loginForm">
					<?php if ($_SESSION['user']['rol'] == true) : ?>
						<div class="card-header">
							<div class="row">
								<h2 class="mb-0 col-auto">Modifique los datos de <?php echo $user->username ?>, id = </h2>
								<div class="col-md-1 mt-2 mt-md-0">
									<input readonly type="text" id="id" name="id" class="form-control" placeholder="id" value="<?php echo $user->id ?>" />
								</div>
								<div class="form-check form-switch col-auto mt-2 ms-3 ms-md-0">
									<input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" <?php echo $user->rol ? 'checked' : '' ?> name="rol" value="1" maxlength="50">
					...
					<div class="card-body pt-0 pb-0">
						<?php if (isset($_GET['error']) && $_GET['error'] == "username") : ?>
							<div class="row">
								<div class="col-12 mt-3">
									<div class="alert alert-danger" role="alert" id="emailErrorMessage" style="margin-bottom: 0;">
						...
						<div class="row">
							<div class="input-group mt-3">
								<span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-1-square" viewBox="0 0 16 16">
										<path d="M9.283 4.002V12H7.971V5.338h-.065L6.072 6.656V5.385l1.899-1.383z" />
										<path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1z" />
									</svg></span>
								<input type="text" id="nombre" name="nombre" aria-label="First name" class="form-control" placeholder="Nombre" value="<?php echo $user->name ?>" />
								<span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-2-square" viewBox="0 0 16 16">
										<path d="M6.646 6.24v.07H5.375v-.064c0-1.213.879-2.402 2.637-2.402 1.582 0 2.613.949 2.613 2.215 0 1.002-.6 1.667-1.287 2.43l-.096.107-1.974 2.22v.077h3.498V12H5.422v-.832l2.97-3.293c.434-.475.903-1.008.903-1.705 0-.744-.557-1.236-1.313-1.236-.843 0-1.336.615-1.336 1.306" />
										<path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1z" />
									</svg></span>
								<input type="text" id="apellido" name="apellido" aria-label="Last name" class="form-control" placeholder="Apellido/s" value="<?php echo $user->surname ?>" maxlength="50" />
							</div>
						</div>
						<div class="row">
							<div class="input-group mt-3">
								...
								<input type="email" class="form-control" placeholder="Correo electrónico" aria-label="Email" aria-describedby="basic-addon1" id="email" name="email" value="<?php echo $user->email ?>" maxlength="50" />
							</div>
						</div>
						<div class="row">
							<div class="col-12 mt-3">
						...
						<div class="row">
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Usuario" aria-label="Username" aria-describedby="basic-addon1" id="validationDefaultUsername" name="validationDefaultUsername" value="<?php echo $user->username ?>" maxlength="50" />
							</div>
						</div>
						<div class="row">
							<div class="col-12">
						...
						<div class="row">
							<div class="input-group mb-3">
								...
								<input type="password" class="form-control" placeholder="Contraseña (si se deja el campo vacío no cambia la contraseña)" aria-label="Password" aria-describedby="basic-addon1" id="password" name="password" maxlength="20" />
							</div>
						</div>
					</div>
