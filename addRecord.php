...
/*if (is_writable($targetDir)) {
    echo "EL directorio tiene permisos";
} else {
    echo "El directorio no tiene permisos";
}*/
            ...
            <div class="card mt-3 col-12">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" id="loginForm"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-md-6 mt-3 mt-md-0 mb-3">
                                <div class="input-group mt-2">
                                    ...
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="rating"
                                            id="flexRadioDefault3" value="3" checked>
                    ...
                    <div class="card-footer">
                        <button class="btn text-white boton-verde" type="submit" name="btnSend">Añadir disco</button>
                    </div>
                </form>
            </div>
        </div>
